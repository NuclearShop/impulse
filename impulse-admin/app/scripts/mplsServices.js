...
ImpulseApp.service("ServerQueryService", function ($http, $q) {
    ...
    function getAllAds(id) {
        var def = $q.defer();

        $http.get("/api/admin/0/0")
    ...
    function getUserRequests(url) {
        var def = $q.defer();

        $http.get("/api/ad/request/" + url)
            .success(function (data) {
                def.resolve(data);
            })
            .error(function () {
    ...
    function getUserReviews() {
        ...
        $http.get("/api/notifications/reviews")
            .success(function (data) {
                def.resolve(data);
            })
            .error(function () {
    ...
    function review(moderatorReview) {
        var def = $q.defer();

        $http.post("/api/admin/view", moderatorReview)
            .success(function (data) {
                def.resolve(data);
            })
            .error(function () {
